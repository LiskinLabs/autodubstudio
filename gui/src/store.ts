...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'dubbing.api_key_required_suffix': 'requires an API key.',
    'dubbing.btn.save': 'Save',
    'dubbing.glossary.placeholder': 'e.g. Teknorob = Teknorob (do not translate)\nJohn = Jonathan',
    // Pipeline Steps
    'step.source': 'Source',
    'step.demucs': 'Demucs',
    ...
    'dubbing.source.title': 'Select Video Source',
    ...
    'dubbing.timeline.title': 'Interactive Timeline',
    'dubbing.timeline.hint': 'Drag edges to resize segments, or drag the center to move them.',
    'dubbing.speakers.title': 'Speakers',
    'loading.waveform': 'Loading Waveform...',
    ...
    'dubbing.adv.user_glossary': 'User Glossary',
    'dubbing.adv.user_glossary_desc': 'Use custom term translations from your glossary for consistent terminology',
    'dubbing.adv.whisper_engine': 'Whisper Engine',
    'dubbing.adv.whisper_desc': 'Choose the speech recognition engine for transcription',
    'dubbing.adv.whisper_std': 'Standard (Faster-Whisper)',
    'dubbing.adv.whisperx': 'Better Align (WhisperX — word-level)',
    'dubbing.adv.max_duration': 'Test Dubbing (seconds)',
    'dubbing.adv.max_duration_desc': '0 = full video. Set seconds for a quick pipeline test.',
    'dubbing.adv.local_only': 'Local Dubbing (No Cloud)',
    'dubbing.adv.local_only_desc': 'Strictly forbid sending text and audio to cloud APIs (DeepL, Google). Only local AI works.',
    ...
    'settings.system_deps': 'System Dependencies',
    'settings.refresh_deps': 'Refresh Status',
    'settings.system_deps_desc': 'Core dependencies required for the application to function properly.',
    ...
    'settings.models.loading': 'Connecting to local AI Backend...',
    'settings.models.loading_desc': 'Please wait a moment while the models are checked.',
    'settings.keys': 'API Keys',
    'settings.glossaries': 'Glossaries',
    'glossary.saved_title': 'Saved Glossaries',
    'glossary.empty': 'No glossaries yet. Create one below.',
    'glossary.new_title': 'New Glossary',
    'glossary.edit': 'Edit',
    'glossary.terms': 'terms',
    'glossary.terms_found': 'terms found',
    'glossary.name_placeholder': 'Glossary name (e.g. Teknorob Terms)',
    'glossary.term_original': 'Term',
    'glossary.term_translation': 'Translation',
    'glossary.add_term': 'Add Term',
    'glossary.ai_suggest': 'AI Suggest',
    'glossary.generating': 'Generating...',
    'glossary.save': 'Save',
    'glossary.delete': 'Delete',
    'glossary.untitled': 'Untitled',
    'glossary.saved': 'Glossary saved',
    'glossary.save_failed': 'Failed to save glossary',
    'glossary.load_failed': 'Failed to load glossary',
    'glossary.delete_failed': 'Failed to delete glossary',
    'glossary.ai_done': 'AI suggestions ready',
    'glossary.ai_failed': 'AI generation failed',
    ...
    'settings.env_diagnostics': 'Environment Diagnostics',
    'settings.env_desc': 'Run a deep dependency test on all loaded ML libraries (Whisper, Demucs, TTS, etc.) to catch missing modules or broken virtual environments.',
    'settings.env_run': 'Run Environment Test',
    'settings.env_testing': 'Testing Environment...',
    'settings.env_results': 'Test Results:',
  ...
  ru: {
    ...
    'dubbing.api_key_required_suffix': 'требуется API ключ.',
    'dubbing.btn.save': 'Сохранить',
    'dubbing.glossary.placeholder': 'e.g. Teknorob = Teknorob (do not translate)\nJohn = Джонатан',
    // Navigation
    ...
    'settings.models.loading': 'Подключение к ИИ-бэкенду...',
    'settings.models.loading_desc': 'Пожалуйста, подождите. Идет проверка статуса.',
    'settings.keys': 'Ключи API',
    'settings.glossaries': 'Глоссарии',
    'glossary.saved_title': 'Сохранённые глоссарии',
    'glossary.empty': 'Глоссариев пока нет. Создайте новый.',
    'glossary.new_title': 'Новый глоссарий',
    'glossary.edit': 'Редактирование',
    'glossary.terms': 'терминов',
    'glossary.terms_found': 'терминов найдено',
    'glossary.name_placeholder': 'Название глоссария (напр. Термины Teknorob)',
    'glossary.term_original': 'Термин',
    'glossary.term_translation': 'Перевод',
    'glossary.add_term': 'Добавить термин',
    'glossary.ai_suggest': 'ИИ-подбор',
    'glossary.generating': 'Генерация...',
    'glossary.save': 'Сохранить',
    'glossary.delete': 'Удалить',
    'glossary.untitled': 'Без названия',
    'glossary.saved': 'Глоссарий сохранён',
    'glossary.save_failed': 'Не удалось сохранить глоссарий',
    'glossary.load_failed': 'Не удалось загрузить глоссарий',
    'glossary.delete_failed': 'Не удалось удалить глоссарий',
    'glossary.ai_done': 'ИИ-подбор готов',
    'glossary.ai_failed': 'ИИ-генерация не удалась',
    ...
    'dubbing.source.title': 'Выберите источник видео',
    ...
    'dubbing.timeline.title': 'Временная шкала',
    'dubbing.timeline.hint': 'Тяните за края для изменения размера сегментов, или за центр для перемещения.',
    'dubbing.speakers.title': 'Спикеры',
    'loading.waveform': 'Загрузка сигнала...',
    // Pipeline steps
    ...
    'settings.env_diagnostics': 'Диагностика окружения',
    'settings.env_desc': 'Проведите глубокий тест зависимостей для всех ML библиотек (Whisper, Demucs, TTS и т.д.), чтобы выявить сломанное окружение или отсутствие модулей.',
    'settings.env_run': 'Запустить тест',
    'settings.env_testing': 'Проверка окружения...',
    'settings.env_results': 'Результаты тестирования:',
    ...
    'dubbing.adv.user_glossary': 'Пользовательский глоссарий',
    'dubbing.adv.user_glossary_desc': 'Использовать пользовательские переводы терминов для консистентной терминологии',
    'dubbing.adv.whisper_engine': 'Движок распознавания',
    'dubbing.adv.whisper_desc': 'Выберите движок распознавания речи для транскрибации',
    'dubbing.adv.whisper_std': 'Стандартный (Faster-Whisper)',
    'dubbing.adv.whisperx': 'Точный (WhisperX — пословная разметка)',
    'dubbing.adv.max_duration': 'Тестовый дубляж (секунд)',
    'dubbing.adv.max_duration_desc': '0 = полное видео. Укажите секунды для быстрого теста пайплайна.',
    'dubbing.adv.local_only': 'Локальный дубляж (Без облаков)',
    'dubbing.adv.local_only_desc': 'Строго запрещает отправку текста и аудио в облачные API (DeepL, Google). Работают только локальные ИИ.',
    ...
    'settings.system_deps': 'Системные зависимости',
    'settings.refresh_deps': 'Обновить статус',
    'settings.system_deps_desc': 'Базовые зависимости, необходимые для правильной работы приложения.',
  ...
  tr: {
    'dubbing.nlp_spacy_title': 'Akıllı NLP Bölücü (Spacy)',
    'dubbing.nlp_spacy_desc': 'Kelimeleri ortadan bölmek yerine anlam ve noktalama işaretlerine göre mükemmel kesim.',
    'dubbing.api_key_required_prefix': 'Sağlayıcı',
    'dubbing.api_key_required_suffix': 'API anahtarı gerektirir.',
    'dubbing.btn.save': 'Kaydet',
    'dubbing.glossary.placeholder': 'Örn. Teknorob = Teknorob (çevirme)\nJohn = Jonathan',
    // Navigation
    'nav.dubbing': 'Dublaj Stüdyosu',
    'frun.opened_url': 'Manuel kurulum için tarayıcıda açıldı.',
    'frun.optional_cloud': 'İsteğe bağlı (Bulut API)',
    ...
    'settings.models.loading': 'Yapay Zeka Sistemine Bağlanılıyor...',
    'settings.models.loading_desc': 'Modeller kontrol edilirken lütfen bekleyin.',
    'settings.keys': 'API Anahtarları',
    'settings.glossaries': 'Sözlükler',
    'glossary.saved_title': 'Kayıtlı Sözlükler',
    'glossary.empty': 'Henüz sözlük yok. Yeni bir tane oluşturun.',
    'glossary.new_title': 'Yeni Sözlük',
    'glossary.edit': 'Düzenle',
    'glossary.terms': 'terim',
    'glossary.terms_found': 'terim bulundu',
    'glossary.name_placeholder': 'Sözlük adı (örn. Teknorob Terimleri)',
    'glossary.term_original': 'Terim',
    'glossary.term_translation': 'Çeviri',
    'glossary.add_term': 'Terim Ekle',
    'glossary.ai_suggest': 'Yapay Zeka Öner',
    'glossary.generating': 'Oluşturuluyor...',
    'glossary.save': 'Kaydet',
    'glossary.delete': 'Sil',
    'glossary.untitled': 'İsimsiz',
    'glossary.saved': 'Sözlük kaydedildi',
    'glossary.save_failed': 'Sözlük kaydedilemedi',
    'glossary.load_failed': 'Sözlük yüklenemedi',
    'glossary.delete_failed': 'Sözlük silinemedi',
    'glossary.ai_done': 'Yapay zeka önerileri hazır',
    'glossary.ai_failed': 'Yapay zeka oluşturma başarısız',
    ...
    'dubbing.source.title': 'Video Kaynağı Seçin',
    ...
    'dubbing.timeline.title': 'Zaman Çizelgesi',
    'dubbing.timeline.hint': 'Segmentleri yeniden boyutlandırmak için kenarları, taşımak için ortasını sürükleyin.',
    'dubbing.speakers.title': 'Konuşmacılar',
    'loading.waveform': 'Dalga Formu Yükleniyor...',
    // Pipeline steps
    ...
    'settings.env_diagnostics': 'Ortam Tanılaması',
    'settings.env_desc': 'Eksik modülleri veya bozuk sanal ortamları yakalamak için tüm yüklü ML kitaplıklarında (Whisper, Demucs, vb.) derin bir bağımlılık testi çalıştırın.',
    'settings.env_run': 'Ortam Testini Çalıştır',
    'settings.env_testing': 'Ortam Test Ediliyor...',
    'settings.env_results': 'Test Sonuçları:',
    ...
    'dubbing.adv.user_glossary': 'Kullanıcı Sözlüğü',
    'dubbing.adv.user_glossary_desc': 'Tutarlı terminoloji için özel terim çevirilerinizi kullanın',
    'dubbing.adv.whisper_engine': 'Tanıma Motoru',
    'dubbing.adv.whisper_desc': 'Konuşma tanıma için kullanılacak motoru seçin',
    'dubbing.adv.whisper_std': 'Standart (Faster-Whisper)',
    'dubbing.adv.whisperx': 'Hassas (WhisperX — kelime düzeyinde)',
    'dubbing.adv.max_duration': 'Test Dublaj (saniye)',
    'dubbing.adv.max_duration_desc': '0 = tam video. Hızlı bir işlem testi için saniye belirtin.',
    'dubbing.adv.local_only': 'Yerel Dublaj (Bulut Yok)',
    'dubbing.adv.local_only_desc': 'Metin ve seslerin bulut API\'lerine (DeepL, Google) gönderilmesini kesinlikle engeller. Yalnızca yerel YZ çalışır.',
    ...
    'settings.system_deps': 'Sistem Bağımlılıkları',
    'settings.refresh_deps': 'Durumu Yenile',
    'settings.system_deps_desc': 'Uygulamanın düzgün çalışması için gereken temel bağımlılıklar.',
...
class SettingsStore {
  ...
  private async _initStore() {
    try {
      ...
      const storedGlossary = await this._store.get<string>('userGlossary');
      if (storedGlossary !== undefined) this.userGlossary = storedGlossary;
  ...
  async setUserGlossary(glossary: string) {
    this.userGlossary = glossary;
    await this._storeReady;
    if (this._store) {
      await this._store.set('userGlossary', glossary);
      await this._store.save();
    }
    this.notify();
  }
...
export function useSettings() {
  ...
  return {
    ...
    userGlossary: settingsStore.userGlossary,
    setUserGlossary: (g: string) => settingsStore.setUserGlossary(g),
    settings: {
