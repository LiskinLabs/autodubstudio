...
function Settings({ activeTab = "settings-general" }: { activeTab?: string }) {
  ...
  const ENV_TESTS = [
    ...
    { id: "whisperx", name: "WhisperX (word-level align)" },
    { id: "f5_tts", name: "F5-TTS (Voice Cloning)" },
    { id: "qwen3_tts", name: "Qwen3-TTS (Voice Cloning)" },
    { id: "coqui_tts", name: "Coqui TTS / XTTSv2" },
    { id: "demucs", name: "Demucs (Audio Separation)" },
    { id: "pyannote", name: "Pyannote (Diarization)" },
    { id: "google_translate", name: "Google Translate" },
    { id: "edge_tts", name: "Microsoft Edge TTS" },
    { id: "ollama", name: "Ollama API (Local LLM)" },
